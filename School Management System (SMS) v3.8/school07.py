     ...
     for j in sch:
        if j==ADMNO:
            ...
            while ans.lower()=='o':
                ...
                if ch=='N':
                    print()
                    n=input("Enter the student's updated Full Name: ")
                    sch[j][0]=n
                    print("*** STUDENT'S RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='F':
                    print()
                    f=input("Enter the student's updated Father's Name: ")
                    sch[j][1]=f
                    print("*** STUDENT'S RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='M':
                    print()
                    m=input("Enter the student's updated Mother's Name: ")
                    sch[j][2]=m
                    print("*** STUDENT'S RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='J':
                    print()
                    j=input("Enter the student's updated Guardian's Name: ")
                    sch[j][27]=j
                    print("*** STUDENT'S RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='DOB':
                    print()
                    dob=input("Enter the student's updated Date Of Birth: ")
                    sch[j][5]=dob
                    print("*** STUDENT'S RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='G':
                    print()
                    g=input("Enter the student's updated Gender as either MALE or M, FEMALE or F, THIRD GENDER or TG: ")
                    if g=='MALE' or g=='FEMALE' or g=='THIRD GENDER' or g=='M' or g=='F' or g=='TG' :
                        ...
                        print("--> Please provide the valid sex of the student to update the student's sex field __/\__")
                        print()
                        g=input("Enter the student's updated Gender as either MALE or M, FEMALE or F, THIRD GENDER or TG: ").upper()
                        if g=='MALE' or g=='FEMALE' or g=='THIRD GENDER' or g=='M' or g=='F' or g=='TG' :
                            sch[j][4]=g
                    ...
                    if len(str(fpn))==10:
                        ...
                        print("--> Please provide the valid mobile/phone number of the student's father to update the student's father's mobile/phone number field __/\__")
                        print()
                        print("// Note:- Mobile/Phone number must be of 10 digits (without ISD code) //")
                        fpn=int(input("Enter the updated Mobile/Phone Number of the student's father: +91 "))
                        if len(str(fpn))==10:
                    ...
                    if len(str(mpn))==10:
                        ...
                        print("--> Please provide the valid mobile/phone number of the student's mother to update the student's mother's mobile/phone number field __/\__")
                        print()
                        print("// Note:- Mobile/Phone number must be of 10 digits (without ISD code) //")
                        mpn=int(input("Enter the updated Mobile/Phone Number of the student's mother: +91 "))
                        if len(str(mpn))==10:
                    ...
                    if len(str(gcn))==10:
                        ...
                        print("--> Please provide the valid contact number of the student's guardian to update the student's guardian's contact number field __/\__")
                        print()
                        print("// Note:- Contact number must be of 10 digits (without ISD code) //")
                        gcn=int(input("Enter the updated Contact Number of the student's guardian: +91 "))
                        if len(str(gcn))==10:
                    ...
                    if '@' and '.com' in s_email:
                        ...
                        print("--> Please provide the proper Email Address of the student's father/mother to update the student's father's/mother's email address field __/\__")
                        print()
                    ...
                    print()
                    a=input("Enter the student's updated House Address: ")
                    sch[j][8]=a
                    print("*** STUDENT'S RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    ...
                    print()
                    h=input("Enter the student's updated House: ")
                    sch[j][25]=h
                    print("*** STUDENT'S RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='C':
                    print()
                    c=input("Enter the student's updated Class: ").upper()
                    if s_cls=='LKG' or s_cls=='UKG' or s_cls=='1' or s_cls=='ONE' or s_cls=='I' or s_cls=='2' or s_cls=='TWO' or s_cls=='II' or s_cls=='3' or s_cls=='THREE' or s_cls=='III' or s_cls=='4' or s_cls=='FOUR' or s_cls=='IV' or s_cls=='5' or s_cls=='FIVE' or s_cls=='V' or s_cls=='6' or s_cls=='SIX' or s_cls=='VI' or s_cls=='7' or s_cls=='SEVEN' or s_cls=='VII' or s_cls=='8' or s_cls=='EIGHT' or s_cls=='VIII' or s_cls=='9' or s_cls=='NINE' or s_cls=='IX' or s_cls=='10' or s_cls=='TEN' or s_cls=='X' or s_cls=='11' or s_cls=='ELEVEN' or s_cls=='XI' or s_cls=='12' or s_cls=='TWELEVE' or s_cls=='XII':
                        ...
                        print("--> Please provide the valid class of the student to update the student's class field __/\__")
                        print()
                        s_cls=input("Enter the student's updated Class: ").upper()
                        if s_cls=='LKG' or s_cls=='UKG' or s_cls=='1' or s_cls=='ONE' or s_cls=='I' or s_cls=='2' or s_cls=='TWO' or s_cls=='II' or s_cls=='3' or s_cls=='THREE' or s_cls=='III' or s_cls=='4' or s_cls=='FOUR' or s_cls=='IV' or s_cls=='5' or s_cls=='FIVE' or s_cls=='V' or s_cls=='6' or s_cls=='SIX' or s_cls=='VI' or s_cls=='7' or s_cls=='SEVEN' or s_cls=='VII' or s_cls=='8' or s_cls=='EIGHT' or s_cls=='VIII' or s_cls=='9' or s_cls=='NINE' or s_cls=='IX' or s_cls=='10' or s_cls=='TEN' or s_cls=='X' or s_cls=='11' or s_cls=='ELEVEN' or s_cls=='XI' or s_cls=='12' or s_cls=='TWELEVE' or s_cls=='XII':
                            sch[j][3]=c
                            print("*** NOW STUDENT'S RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                        else:
