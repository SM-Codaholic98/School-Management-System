        ...
        if j==ID:
            ...
            while ans.lower()=='o':
                ...
                if ch=='N':
                    ...
                    q=input("Enter the updated Qualification(degree) of the teacher as B.Sc or BCA or B.Tech for Bachelor's degree and M.Sc or MCA or M.Tech for Master's degree (Note:- B.Ed is compulsory): ").upper()
                    if '.' in q:
                        q=q.replace('.','')
                    sch[j][2]=q
                    print("*** TEACHER'S RECORD HAS BEEN SUCCESSFULLY UPDATED !!! ***")
