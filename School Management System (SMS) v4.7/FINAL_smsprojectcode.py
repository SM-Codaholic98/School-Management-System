  ...
  while ANS.upper()=='H':
    ...
    if ch==1:
        ...
        while ANS.upper()=='Y':
         ...
         print("# Press 1 to insert the record of the science teachers")
         ...
         print("# Press 4 to append the record of the science teachers")
         print("# Press 5 to search the record of the science teachers")
         print("# Press 6 to update the record of the science teachers")
        ...
        while ANS.upper()=='Y':
         ...
         print("# Press 1 to insert the record of the commerce teachers")
         ...
         print("# Press 4 to append the record of the commerce teachers")
         print("# Press 5 to search the record of the commerce teachers")
         print("# Press 6 to update the record of the commerce teachers")
        ...
        while ANS.upper()=='Y':
         ...
         print("# Press 1 to insert the record of the arts teachers")
         ...
         print("# Press 4 to append the record of the arts teachers")
         print("# Press 5 to search the record of the arts teachers")
         print("# Press 6 to update the record of the arts teachers")
        ...
        while ANS.upper()=='Y':
         ...
         print("# Press 1 to insert the record of the group-A staffs")
         ...
         print("# Press 4 to append the record of the group-A staffs")
         print("# Press 5 to search the record of the group-A staffs")
         print("# Press 6 to update the record of the group-A staffs")
        ...
        while ANS.upper()=='Y':
         ...
         print("# Press 1 to insert the record of the group-B staffs")
         ...
         print("# Press 4 to append the record of the group-B staffs")
         print("# Press 5 to search the record of the group-B staffs")
         print("# Press 6 to update the record of the group-B staffs")
        ...
        while ANS.upper()=='Y':
         ...
         print("# Press 3 to append the record of the students")
         print("# Press 4 to search the record of the students")
         print("# Press 5 to update the record of the students")
