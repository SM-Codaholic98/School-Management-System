...
def INSERT_COMM_TEACH_REC():
    f=open('SMS_COMM_TEACH.dat','wb')
    ans='i'
    while ans.lower()=='i':
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        print("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& INSERT TEACHER'S DETAILS &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&")
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        ...
        t_q=input("Enter the teacher's Qualification(degree) as either B.Com or BBA for the Bachelor's degree and as either M.Com or MBA for the Master's degree (Note:- B.Ed is compulsory): ").upper()
        if '.' in t_q:
            t_q=t_q.replace('.','')
        print()
...
bp2=35000   
bp3=40000    
def COMPUTE_COMM_TEACH_REC():
    
    global percent,bp1,bp2,bp3
    
    f=open('SMS_COMM_TEACH.dat','rb+')
    sch={}
    while True:
        try:
            sch=pickle.load(f)
     ...
     for i in sch:
       if i==ID:
        ...
        if sch[i][9]>21 and sch[i][9]<61:
            if "BED" in sch[i][2] and ("BCOM" in sch[i][2] or "BBA" in sch[i][2]):
                if ("MCOM" not in sch[i][2] and "MBA" not in sch[i][2]) and "PHD" not in sch[i][2]:
                ...
                print("~~~ NOTE: Teacher's ID NUMBER -",i,",NAME -",sch[i][0],",AGE -",sch[i][9],"& QUALIFICATION -",sch[i][2],"will be appointed in the school, if the teacher must have B.Ed and (B.Com or BBA) ~~~")    
...
def APPEND_COMM_TEACH_REC():
    ...
    f=open('SMS_COMM_TEACH.dat','ab')
    ans='a'
    while ans.lower()=='a':
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        print("&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& APPEND TEACHER'S DETAILS &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&")
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        t_id=random.randint(100000,999999)
        t_name=input("Enter the teacher's Full Name: ")
        print("ID Number of",t_name,"is: ",t_id)
     ...
     for j in sch:
        if j==ID:
            ...
            while ans.lower()=='o':
                ...
                if ch=='N':
                    print()
                    n=input("Enter the teacher's updated Full Name: ")
                    sch[j][0]=n
                    print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='H':
                    print()
                    h=input("Enter the teacher's updated Father's Name: ")
                    sch[j][32]=h
                    print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='W':
                    print()
                    w=input("Enter the teacher's updated Mother's Name: ")
                    sch[j][33]=w
                    print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='U':
                    print()
                    u=input("Enter the teacher's updated Spouse's Name: ")
                    sch[j][34]=u
                    print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='J':
                    print()
                    j=input("Enter the teacher's updated Guardian's Name: ")
                    sch[j][35]=j
                    print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='T':
                    print()
                    t=input("Enter the teacher's updated Teaching Subject: ")
                    sch[j][1]=t
                    print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='D':
                    print()
                    d=input("Enter the teacher's updated Date Of Birth: ")
                    sch[j][4]=d
                    print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    
                elif ch=='S':
                    print()
                    s=input("Enter the teacher's updated Gender as either MALE or M, FEMALE or F, THIRD GENDER or TG: ")
                    if s=='MALE' or s=='FEMALE' or s=='THIRD GENDER' or s=='M' or s=='F' or s=='TG' :
                        sch[j][5]=s
                        print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    else:
                        print()
                        print("*** TEACHER'S DETAIL HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Invalid sex of the teacher has been entered !!! ~~~")
                        print("--> Please provide the valid sex of the teacher to update the teacher's sex field __/\__")
                        print()
                        s=input("Enter the teacher's updated Gender as either MALE or M, FEMALE or F, THIRD GENDER or TG: ").upper()
                        if s=='MALE' or s=='FEMALE' or s=='THIRD GENDER' or s=='M' or s=='F' or s=='TG' :
                            sch[j][5]=s
                            print("*** NOW TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                        else:
                            print()
                            print("*** TEACHER'S DETAIL HAS NOT BEEN UPDATED !!! ***")
                            print("~~~ Invalid sex of the teacher has been entered !!! ~~~")
                    ...
                    print()
                    print("// Note:- Do not give dot in between while typing the teacher's degree //")
                    q=input("Enter the teacher's updated Qualification(degree) as either B.Com or BBA for the Bachelor's degree and as either M.Com or MBA for the Master's degree (Note:- B.Ed is compulsory): ").upper()
                    if '.' in q:
                        q=q.replace('.','')
                    sch[j][2]=q
                    print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    ...
                    print()
                    g=input("Enter the teacher's updated Grade as either PRT, TGT or PGT: ").upper()
                    if g=='PRT' or g=='TGT' or g=='PGT':
                        ...
                        print("*** TEACHER'S DETAIL HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Invalid grade of the teacher has been entered !!! ~~~")
                        print("--> Please provide the valid grade of the teacher to update the teacher's grade field __/\__")
                        print()
                        g=input("Enter the teacher's updated Grade as either PRT, TGT or PGT: ").upper()
                        if g=='PRT' or g=='TGT' or g=='PGT':
                            sch[j][3]=g
                    ...
                    m=int(input("Enter the teacher's updated Mobile/Phone Number: +91 "))
                    if len(str(m))==10:
                        sch[j][19]=m
                        print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    else:
                        ...
                        print("*** TEACHER'S DETAIL HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Invalid mobile/phone number of the teacher has been entered !!! ~~~")
                        print("--> Please provide the valid mobile/phone number of the teacher to update the teacher's mobile/phone number field __/\__")
                        print()
                        print("// Note:- Mobile/Phone number must be of 10 digits (without ISD code) //")
                        m=int(input("Enter the teacher's updated Mobile/Phone Number: +91 "))
                        if len(str(m))==10:
                    ...
                    print()
                    e=input("Enter the teacher's updated Email Address: ")
                    if '@' and '.com' in e:
                        sch[j][20]=e
                        print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    else:
                        ...
                        print("*** TEACHER'S DETAIL HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Teacher's email address doesn't contain '@' or '.com' !!! ~~~")
                        print("--> Please provide the proper email address of the teacher to update the teacher's email address field __/\__")
                        print()
                        e=input("Enter the teacher's updated Email Address: ")
                        if '@' and '.com' in e:
                            sch[j][20]=e
                    ...
                    print()
                    a=input("Enter the teacher's updated House Address: ")
                    sch[j][21]=a
                    print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    ...
                    print()
                    print("// Note:- Aadhaar number must be of 12 digits of numeric type \\")
                    r=int(input("Enter the teacher's updated Aadhaar Number: "))
                    if len(str(r))==12:
                        sch[j][22]=r
                        print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    else:
                        ...
                        print("*** TEACHER'S DETAIL HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Invalid aadhaar number of the teacher has been entered !!! ~~~")
                        print("--> Please provide the valid aadhaar number of the teacher to update the teacher's aadhaar number field __/\__")
                        print()
                        print("// Note:- Aadhaar number must be of 12 digits of numeric type \\")
                        r=int(input("Enter the teacher's updated Aadhaar Number: "))
                        if len(str(r))==12:
                    ...
                    print()
                    print("// Note:- Permanent Account Number (PAN) must be of 10 digits of alpha-numeric type \\")
                    p=input("Enter the teacher's updated PAN Number: ")
                    if len(p)==10:
                        sch[j][23]=p
                        print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    else:
                        ...
                        print("*** TEACHER'S DETAIL HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Invalid PAN number of the teacher has been entered !!! ~~~")
                        print("--> Please provide the valid PAN number of the teacher to update the teacher's PAN number field __/\__")
                        print()
                        print("// Note:- Permanent Account Number (PAN) must be of 10 digits of alpha-numeric type \\")
                        p=input("Enter the teacher's updated PAN Number: ")
                        if len(p)==10:
                    ...
                    print()
                    c=input("Enter the teacher's updated Customer ID Number: ")
                    sch[j][24]=c
                    print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    ...
                    print()
                    print("// Note:- Indian Financial System Code (IFSC Code) must be of 11 digits of alpha-numeric type \\")
                    f=input("Enter the teacher's updated IFSC Code: ")
                    if len(f)==11:
                        sch[j][25]=f
                        print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    else:
                        ...
                        print("*** TEACHER'S DETAIL HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Invalid IFSC Code of the teacher has been entered !!! ~~~")
                        print("--> Please provide the valid IFSC Code of the teacher to update the teacher's IFSC Code field __/\__")
                        print()
                        print("// Note:- Indian Financial System Code (IFSC Code) must be of 11 digits of alpha-numeric type \\")
                        f=input("Enter the teacher's updated IFSC Code: ")
                        if len(f)==11:
                    ...
                    print()
                    print("// Note:- Magnetic Ink Character Recognition Code (MICR Code) must be of 9 digits of numeric type \\")
                    i=int(input("Enter the teacher's updated MICR Code: "))
                    if len(str(i))==12:
                        sch[j][26]=i
                        print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    else:
                        ...
                        print("*** TEACHER'S DETAIL HAS NOT BEEN UPDATED !!! ***")
                        print("~~~ Invalid MICR Code of the teacher has been entered !!! ~~~")
                        print("--> Please provide the valid MICR Code of the teacher to update the teacher's MICR Code field __/\__")
                        print()
                        print("// Note:- Magnetic Ink Character Recognition Code (MICR Code) must be of 9 digits of numeric type \\")
                        i=int(input("Enter the teacher's updated MICR Code: "))
                        if len(str(i))==12:
                    ...
                    print()
                    acnt=input("Enter the teacher's updated Account Number: ")
                    sch[j][27]=acnt
                    print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
