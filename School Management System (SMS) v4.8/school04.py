        ...
        if j==ID:
            ...
            while ans.lower()=='o':
                ...
                if ch=='N':
                    ...
                    print()
                    print("// Note:- Do not give dot in between while typing the staff's degree //")
                    q=input("Enter the staff's updated Qualification (Note:- Bachelor's degree is compulsory): ").upper()
                    if '.' in q:
                        q=q.replace('.','')
                    sch[j][2]=q
                    print("*** STAFF'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    ...
                    print()
                    g=input("Enter the staff's updated Grade as either RECEPTIONIST, CLERK, HEAD CLERK, OFFICE SUPERINTENDENT or OFFICE ASSISTANT: ").upper()
