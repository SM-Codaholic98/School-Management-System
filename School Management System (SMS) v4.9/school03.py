        ...
        if j==ID:
            ...
            while ans.lower()=='o':
                ...
                if ch=='N':
                    ...
                    q=input("Enter the updated Qualification(degree) of the teacher as either BA or BFA for the Bachelor's degree and as either MA or MFA for the Master's degree (Note:- B.Ed is compulsory): ").upper()
                    if '.' in q:
                        q=q.replace('.','')
                    sch[j][2]=q
                    print("*** TEACHER'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
