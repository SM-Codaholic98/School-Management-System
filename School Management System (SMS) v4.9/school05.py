        ...
        if j==ID:
            ...
            while ans.lower()=='o':
                ...
                if ch=='Q':
                    ...
                    q=input("Enter the updated Qualification of the staff (Note:- HS pass is compulsory): ").upper()
                    if '.' in q:
                        q=q.replace('.','')
                    sch[j][2]=q
                    print("*** STAFF'S DETAIL HAS BEEN SUCCESSFULLY UPDATED !!! ***")
                    ...
                    print()
                    g=input("Enter the updated Grade of the staff as either DRIVER, GARDENER, SWEEPER or SECURITY: ").upper()
